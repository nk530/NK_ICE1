...
public class CardTrick {
    ...
    private static void printInfo() {
        ...
        System.out.println("My name is Jeetun Nevish, but you can call me NK or Nav");
        System.out.println();
        
        System.out.println("My career ambitions:");
        System.out.println("-- Make more money");
        System.out.println("-- Make even more money");
	System.out.println();	

        System.out.println("My hobbies:");
        System.out.println("-- watching horror movies");
